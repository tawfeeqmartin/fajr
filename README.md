...
2. **Check your settings** — madhab default, elevation correction, calculation method are all auto-dispatched and may not match your community's practice. Most relevantly: Pakistan / Bangladesh / Türkiye / Albania are Hanafi-majority but currently dispatch on adhan.js's Shafi'i 1× shadow Asr default; fix tracked in [#40](https://github.com/tawfeeqmartin/fajr/issues/40). Saudi Arabia institutionally declines elevation correction for jama'ah unity; UAE/JAKIM apply it. Pass `elevation: 0` to opt out of fajr's auto-applied elevation correction.
