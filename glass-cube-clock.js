...
(function loop() {
  ...
  if (!window._grainOverlay) {
    ...
    var _grainFreq = (0.45 / (window.devicePixelRatio || 1)).toFixed(3);
    _grainSvg.innerHTML = '<filter id="grainFilter"><feTurbulence type="fractalNoise" baseFrequency="' + _grainFreq + '" numOctaves="3" stitchTiles="stitch"/><feColorMatrix type="saturate" values="0"/></filter>';
