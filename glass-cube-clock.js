...
(function loop() {
  ...
  var _camStiffness = (_swipePreviewIdx >= 0) ? 0.30 : 0.008; // instant during drag, glacial on release
  var _camDamping = (_swipePreviewIdx >= 0) ? 0.58 : 0.95; // tight during drag, overdamped home
