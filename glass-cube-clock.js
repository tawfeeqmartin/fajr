...
(function loop() {
  ...
  if (!window._grainOverlay) {
    ...
    _grainEl.style.cssText = 'position:fixed;inset:0;z-index:1;pointer-events:none;filter:url(#grainFilter);opacity:0.50;mix-blend-mode:soft-light;background:white;';
...
function _devBuildPanel() {
  ...
  document.getElementById('_devGrainStrength').addEventListener('input', function() {
    ...
    if (window._grainOverlay) window._grainOverlay.style.opacity = v * 0.50;
  });
